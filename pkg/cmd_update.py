...
from utils import parse_package_names, read_config, parse_system_names, find_package_deps
...
def cmd_update(args):
    ...
    # Add dependencies
    dependencies = find_package_deps(db, list(current_metadata['packages'].keys()))
